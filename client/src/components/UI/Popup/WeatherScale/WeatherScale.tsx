...
import styles from './WeatherScale.module.scss';
import WeatherScalePointer from './WeatherScalePointer';

const WeatherScale = ({ dayNumber }: { dayNumber: number }) => {
	const { curve, scale, desc, data } = useAppSelector(selectPopupScale(dayNumber));

	const curveRef = useRef<SVGPathElement>(null);

	return (
		<div className={styles.popup_weather_scale}>
